...
kp_2d = np.load("../keypoint_detection/outputs/baxter_wobbler_2d_keypoints.npy")[:,:7]
b_T_cam_vecs = np.load("../keypoint_detection/outputs/baxter_wobbler_extrinsic.npy")
n = kp_2d.shape[0]
...
for num_loop in range(args.n_l):
    ...
    for itr in range(args.n_q):
        ...
        z = loss_fn(kp_2d, proj_kp, x_t, b_T_cam_torch , w_q = 10, w_c = 10)
